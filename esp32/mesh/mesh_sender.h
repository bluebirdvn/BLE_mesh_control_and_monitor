#ifndef MESH_COMMAND_SENDER_H
#define MESH_COMMAND_SENDER_H
...
public:
    ...
    void group_status(uint16_t addr, const mesh_evt_group_status& group);

    void generic_client_timeout(uint16_t addr, uint8_t orig_opcode_low_byte);
