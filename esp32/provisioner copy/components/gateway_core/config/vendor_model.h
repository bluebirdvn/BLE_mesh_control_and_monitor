...
#define VND_OP_ACTUATOR_THRESHOLD_SET    ESP_BLE_MESH_MODEL_OP_3(0x07, CID_ESP)
#define VND_OP_ACTUATOR_THRESHOLD_GET    ESP_BLE_MESH_MODEL_OP_3(0x08, CID_ESP)
#define VND_OP_ACTUATOR_THRESHOLD_STATUS ESP_BLE_MESH_MODEL_OP_3(0x09, CID_ESP)
#define VND_OP_ACTUATOR_SET           ESP_BLE_MESH_MODEL_OP_3(0x03, CID_ESP)
#define VND_OP_ACTUATOR_STATUS        ESP_BLE_MESH_MODEL_OP_3(0x04, CID_ESP)
#define VND_OP_ACTUATOR_SET_AUTO      ESP_BLE_MESH_MODEL_OP_3(0x10, CID_ESP)
#pragma pack(push, 1)
